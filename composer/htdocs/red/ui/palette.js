...
RED.palette = (function() {
	...
	var exclusion = [];
	var core = ['producer', 'consumer', 'measurement', 'graph', 'filter', 'analyze'];
	...
	function setTooltipContent(prefix, key, elem) {
		...
		options.content = type.summary;
		$(elem).popover(options);
/*
console.log({func:'setTooltipContent', key:key, elem:elem })
		if (!server) {
